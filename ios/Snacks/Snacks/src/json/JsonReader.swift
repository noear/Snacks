...
class JsonReader {
    ...
    /// try read obj
    /// </summary>
    private func ObjTryRead(_ buffer_sb:StringBuilder,_  buffer_char:Character,_ token:JsonToken)->Bool
    {
...
//                        break;
    ...
    private func outputNumber(_ buffer_sb:StringBuilder, _ value_type:ValueType)
    {
        ...
        else
        {
            ...
            Value = Double(buffer_sb.toString())!;
        }
    }
    
    private func outputDateTime(_ buffer_str:String)
    {
        /*
