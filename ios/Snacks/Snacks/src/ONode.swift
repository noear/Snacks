...
public class ONode : ONodeBase {
    ...
    public static func TIME_FORMAT_ACTION(_ data:Date)->String{
        return "";
    }
    ...
    public func remove(_ key:String)->Bool {
        if (_object == nil || _type != ONodeType.Object){
            ...
            return _object!.members.removeValue(forKey:key) != nil;
        }
    }
...
//    }
    ...
    //返回自己
    @discardableResult
    public func add(_ value:ONode) ->ONode{
        tryInitArray();
    ...
    //返回自己
    @discardableResult
    public func set(_ key:String,_ value:ONode)->ONode {
        tryInitObject();
    ...
    //返回自己
    @discardableResult
    public  func set(_ key:String,_ value:String?) ->ONode{
        tryInitObject();
    ...
    //返回自己
    @discardableResult
    public  func set(_ key:String,_ value:Int)->ONode {
        tryInitObject();
        _object!.set(key, ONode(Int32(value)));
    ...
    //返回自己
    @discardableResult
    public  func set(_ key:String,_ value:Int32)->ONode {
        tryInitObject();
        _object!.set(key, ONode(value));
    ...
    //返回自己
    @discardableResult
    public  func set(_ key:String,_ value:Int64) ->ONode{
        tryInitObject();
        _object!.set(key, ONode(value));
    ...
    //返回自己
    @discardableResult
    public  func set(_ key:String,_ value:Double) ->ONode{
        tryInitObject();
        _object!.set(key, ONode(value));
    ...
    //返回自己
    @discardableResult
    public  func set(_ key:String,_ value:Bool) ->ONode{
        tryInitObject();
        _object!.set(key,  ONode(value));
    ...
    //返回自己
    @discardableResult
    public  func set(_ key:String,_ value:Date)->ONode {
        tryInitObject();
        _object!.set(key,  ONode(value));
